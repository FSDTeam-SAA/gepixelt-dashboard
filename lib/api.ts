...
export const getMeals = async (page = 1, limit = 10, day?: string) => {
  ...
  if (day) {
    ...
    console.log("[v0] API URL for getMeals:", url)
  }
...
// Orders API
export const getOrders = async (page = 1, limit = 10, filter?: string, status?: string) => {
...
export const createLocation = async (data: { name: string; address: string }) => {
